...
class ManejoArchivos:
    ...
    def __init__(self,nombre,modo_apertura):
        self.nombre=nombre
    ...
    def __enter__(self):
        ...
        # se modifica la manera como este archivo se abre para que este en modo apend
        self.nombre=open(self.nombre,self.modo,encoding='utf8')
        return self.nombre
