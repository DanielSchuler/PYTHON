...
try:
    with conexion:
        ...
        with conexion.cursor() as cursor:
            ...
            valores = (('calros','lara','la@gmail.com'),
                       ('robert','kani','rk@gmail.com'),
                       ('Pedro','Castillo','pc@gmail.com'))
            # cambio para guardar varios valores execute many
    ...
    # si alguno de los registros genero error se genera un roll back = ninguno de los registros se guarda
